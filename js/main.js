        ...
        let output = `
            ...
            <div class="row m-3">
                <div class="well">
                    ...
                    ${movie.Plot}
                    <hr>
                    <a href="http://imdb.com/title/${movie.imdbID}" target="_blank" class="btn btn-primary m-2">View IMDB
                    </a>
                    <a href="index.html" class="btn btn-danger m-2"> Go Back To Search</a>
                </div>
            </div>
        `;
        $('#movie').html(output);
